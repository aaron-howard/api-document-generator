...
exports.T031ApiGatewayDemo = void 0;
exports.runT031Demo = runT031Demo;
...
class T031ApiGatewayDemo {
    ...
    async initializeServices() {
        ...
        await this.gateway.initialize(configManager, cliService, parserService, aiService, generationService, cacheManager, errorHandler, performanceMonitor);
    ...
    async demonstrateRestAPIs() {
        ...
        try {
            ...
            const healthResponse = await axios_1.default.get(`${this.baseUrl}/api/v1/health`, { headers });
            console.log('✅ Health Check Response:', JSON.stringify(healthResponse.data, null, 2));
            // System status
            console.log('\n📊 Testing System Status Endpoint...');
            const statusResponse = await axios_1.default.get(`${this.baseUrl}/api/v1/status`, { headers });
            console.log('✅ System Status Response:', JSON.stringify(statusResponse.data, null, 2));
            // Configuration retrieval
            console.log('\n⚙️ Testing Configuration Endpoint...');
            const configResponse = await axios_1.default.get(`${this.baseUrl}/api/v1/config`, { headers });
            ...
            try {
                const parseResponse = await axios_1.default.post(`${this.baseUrl}/api/v1/parse`, parseData, { headers });
            ...
            try {
                const generateResponse = await axios_1.default.post(`${this.baseUrl}/api/v1/generate`, generateData, { headers });
                ...
                if (generateResponse.data.data?.jobId) {
                    ...
                    const jobResponse = await axios_1.default.get(`${this.baseUrl}/api/v1/generate/${generateResponse.data.data.jobId}`, { headers });
            ...
            try {
                const cacheResponse = await axios_1.default.get(`${this.baseUrl}/api/v1/cache/stats`, { headers });
            ...
            const perfResponse = await axios_1.default.get(`${this.baseUrl}/api/v1/performance`, { headers });
    ...
    async demonstrateGraphQL() {
        ...
        `
            ...
            const healthResponse = await axios_1.default.post(`${this.baseUrl}/graphql`, healthQuery, {
                headers: {
                    'Content-Type': 'application/json',
                    'X-API-Key': 'demo-key-123'
                }
        ...
        `
            ...
            const configResponse = await axios_1.default.post(`${this.baseUrl}/graphql`, configQuery, {
                headers: {
                    'Content-Type': 'application/json',
                    'X-API-Key': 'demo-key-123'
                }
        ...
        `,
            ...
            const generateResponse = await axios_1.default.post(`${this.baseUrl}/graphql`, generateMutation, {
                headers: {
                    'Content-Type': 'application/json',
                    'X-API-Key': 'demo-key-123'
                }
    ...
    async demonstrateWebSocket() {
        ...
        return new Promise((resolve) => {
            ...
            ws.on('message', (data) => {
                ...
                console.log(`📨 WebSocket Message [${message.type}]:`, message.type === 'welcome' ? 'Connection established' :
    ...
    async demonstrateFileOperations() {
        ...
        try {
            ...
            const uploadResponse = await axios_1.default.post(`${this.baseUrl}/api/v1/upload`, uploadData, {
                headers: {
                    'Content-Type': 'application/json',
                    'X-API-Key': 'demo-key-123'
                }
            ...
            const exportResponse = await axios_1.default.post(`${this.baseUrl}/api/v1/export`, exportData, {
                headers: {
                    'Content-Type': 'application/json',
                    'X-API-Key': 'demo-key-123'
                }
    ...
    async demonstratePerformanceMonitoring() {
        ...
        try {
            ...
            const perfResponse = await axios_1.default.get(`${this.baseUrl}/api/v1/performance`, {
                headers: { 'X-API-Key': 'demo-key-123' }
            });
            ...
            const statusResponse = await axios_1.default.get(`${this.baseUrl}/api/v1/status`, {
                headers: { 'X-API-Key': 'demo-key-123' }
            });
    ...
    async demonstrateConfigurationManagement() {
        ...
        try {
            ...
            const getResponse = await axios_1.default.get(`${this.baseUrl}/api/v1/config`, {
                headers: { 'X-API-Key': 'demo-key-123' }
            });
            ...
            const updateResponse = await axios_1.default.put(`${this.baseUrl}/api/v1/config`, updateData, {
                headers: {
                    'Content-Type': 'application/json',
                    'X-API-Key': 'demo-key-123'
                }
            ...
            const prefResponse = await axios_1.default.put(`${this.baseUrl}/api/v1/preferences/demo-user`, userPreferences, {
                headers: {
                    'Content-Type': 'application/json',
                    'X-API-Key': 'demo-key-123'
                }
            ...
            const getPrefResponse = await axios_1.default.get(`${this.baseUrl}/api/v1/preferences/demo-user`, {
                headers: { 'X-API-Key': 'demo-key-123' }
            });
...
exports.T031ApiGatewayDemo = T031ApiGatewayDemo;
/**
 * Run the T031 API Gateway Integration demonstration
 */
async function runT031Demo() {
...
//# sourceMappingURL=t031-simple-demo.js.map