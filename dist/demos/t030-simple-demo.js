...
class T030ConfigDemo {
    ...
    async demonstrateUserPreferences() {
        ...
        try {
            ...
            for (const profile of profiles) {
                const preferences = await this.configManager.loadUserPreferences(`demo-${profile}`, profile);
    ...
    async createSampleConfigurationFiles() {
        ...
        await fs.writeFile(path.join(configDir, 'config.development.json'), JSON.stringify(envConfig, null, 2), 'utf-8');
...
exports.T030ConfigDemo = T030ConfigDemo;
/**
 * Run the T030 Configuration Management demonstration
 */
...
//# sourceMappingURL=t030-simple-demo.js.map