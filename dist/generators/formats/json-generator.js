...
exports.createJSONGenerator = createJSONGenerator;
/**
...
class JSONGenerator {
    constructor() {
        this.format = 'json';
        this.supportedEngines = ['handlebars', 'mustache'];
        this.defaultTemplate = 'default-json';
    ...
    async renderJSON(template, data, options = {}) {
    ...
    convertEndpointsToPaths(endpoints) {
        const paths = {};
    ...
    hasCircularReferences(schemas) {
        // Simple circular reference detection
        const visiting = new Set();
        const visited = new Set();
        const hasCircular = (schemaName) => {
    ...
    generateWarnings(_request, data) {
        const warnings = [];
        // Check JSON size
